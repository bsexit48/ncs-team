...
export interface Token extends BaseContract {
  ...
  functions: {
    airdrop(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    burn(to: string, value: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    airdrop(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    airdrop(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
